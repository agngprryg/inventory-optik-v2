            ...
            <div class="card   rounded">
                <div class="card-body">
                    ...
                    <div class="container mt-4">
                        <form action="{{ route('gudang.update', $gudang->id) }}" method="POST" class="p-4 border rounded"
                                ...
                                <select type="text" id="manager" name="id_manager" class="form-control" required>
                                    ...
                                    @foreach ($managers as $manager)
                                        <option value="{{ $manager->id }}"
                                            {{ $manager->id == $gudang->id_manager ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="no_telepon" name="no_telepon" class="form-control"
                                    value="{{ $gudang->no_telepon }}" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select type="text" id="status" name="status" class="form-control" required>
                                    ...
                                    <option value="nonaktif" {{ $gudang->status == 'nonaktif' ? 'selected' : '' }}>
                                        NonAktif</option>
                                </select>
                            </div>
