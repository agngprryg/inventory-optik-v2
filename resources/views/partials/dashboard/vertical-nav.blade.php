<ul class="navbar-nav iq-main-menu" id="sidebar">
        ...
        <ul class="sub-nav collapse" id="sidebar-special-pages" data-bs-parent="#sidebar">
            <li class=" nav-item">
                <a class="nav-link {{ activeRoute(route('list-produk.index')) }}"
                    ...
                    <span class="item-name">List Produk</span>
                </a>
            </li>
            <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('auth.signin')) }}" href="{{ route('auth.signin') }}">
                    ...
                    <span class="item-name">Grosir</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('auth.signup')) }}" href="{{ route('auth.signup') }}">
                    ...
                    <i class="sidenav-mini-icon"> R T </i>
                    <span class="item-name">Retail Toko</span>
                </a>
            </li>
        </ul>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link " data-bs-toggle="collapse" href="#sidebar-user" role="button" aria-expanded="false"
            ...
            <span class="item-name">Role User</span>
            <i class="right-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        ...
        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('owner.index')) }}" href="{{ route('owner.index') }}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                            fill="currentColor">
                            <g>
                    ...
                    <span class="item-name">Owner</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('cabang.index')) }}" href="{{ route('cabang.index') }}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                            fill="currentColor">
                            <g>
                    ...
                    <i class="sidenav-mini-icon"> C/T </i>
                    <span class="item-name">Cabang / Toko</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('manager.index')) }}" href="{{ route('manager.index') }}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                            fill="currentColor">
                            <g>
        ...
        <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('errors.error404') }}">
                    ...
                    <span class="item-name">Laporan Stok</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('errors.maintenance') }}">
                    ...
                    <span class="item-name">Laporan Barang Menipis</span>
                </a>
            </li>
        </ul>
    </li>
